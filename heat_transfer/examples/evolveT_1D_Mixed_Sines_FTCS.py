...
# evolve temperature
print("started evolveT_1D_Mixed_Sines_FTCS().")
def evolveT_1D_Mixed_Sines_FTCS():
  directory = "../../data/FTCS_Sines_Mixed_T.txt"
...
evolveT_1D_Mixed_Sines_FTCS()
print("finished evolveT_1D_Mixed_Sines_FTCS().")
